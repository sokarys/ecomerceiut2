...
abstract class BaseArticlePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Nom', 'Description', 'Popularite', 'Stock', 'CategorieId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nom', 'description', 'popularite', 'stock', 'categorieId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NOM, self::DESCRIPTION, self::POPULARITE, self::STOCK, self::CATEGORIE_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'nom', 'description', 'popularite', 'stock', 'categorie_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nom' => 1, 'Description' => 2, 'Popularite' => 3, 'Stock' => 4, 'CategorieId' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nom' => 1, 'description' => 2, 'popularite' => 3, 'stock' => 4, 'categorieId' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NOM => 1, self::DESCRIPTION => 2, self::POPULARITE => 3, self::STOCK => 4, self::CATEGORIE_ID => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nom' => 1, 'description' => 2, 'popularite' => 3, 'stock' => 4, 'categorie_id' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
