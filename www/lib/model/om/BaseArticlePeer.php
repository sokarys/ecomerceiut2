...
/**
 * Base static class for performing query and update operations on the 'magasin_article' table.
 *
 * 
 *
...
abstract class BaseArticlePeer {
	...
	const TABLE_NAME = 'magasin_article';
	...
	const ID = 'magasin_article.ID';

	/** the column name for the NOM field */
	const NOM = 'magasin_article.NOM';

	/** the column name for the PRIX field */
	const PRIX = 'magasin_article.PRIX';

	/** the column name for the DESCRIPTION field */
	const DESCRIPTION = 'magasin_article.DESCRIPTION';

	/** the column name for the POPULARITE field */
	const POPULARITE = 'magasin_article.POPULARITE';

	/** the column name for the STOCK field */
	const STOCK = 'magasin_article.STOCK';

	/** the column name for the CATEGORIE_ID field */
	const CATEGORIE_ID = 'magasin_article.CATEGORIE_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Nom', 'Prix', 'Description', 'Popularite', 'Stock', 'CategorieId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nom', 'prix', 'description', 'popularite', 'stock', 'categorieId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NOM, self::PRIX, self::DESCRIPTION, self::POPULARITE, self::STOCK, self::CATEGORIE_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'nom', 'prix', 'description', 'popularite', 'stock', 'categorie_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nom' => 1, 'Prix' => 2, 'Description' => 3, 'Popularite' => 4, 'Stock' => 5, 'CategorieId' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nom' => 1, 'prix' => 2, 'description' => 3, 'popularite' => 4, 'stock' => 5, 'categorieId' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NOM => 1, self::PRIX => 2, self::DESCRIPTION => 3, self::POPULARITE => 4, self::STOCK => 5, self::CATEGORIE_ID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nom' => 1, 'prix' => 2, 'description' => 3, 'popularite' => 4, 'stock' => 5, 'categorie_id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ArticlePeer::NOM);
		$criteria->addSelectColumn(ArticlePeer::PRIX);
		$criteria->addSelectColumn(ArticlePeer::DESCRIPTION);
		$criteria->addSelectColumn(ArticlePeer::POPULARITE);
		$criteria->addSelectColumn(ArticlePeer::STOCK);
	...
	/**
	 * Method to invalidate the instance pool of all tables related to magasin_article
	...
	/**
	 * Method to DELETE all rows from the magasin_article table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
