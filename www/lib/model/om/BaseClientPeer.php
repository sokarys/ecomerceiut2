...
/**
 * Base static class for performing query and update operations on the 'magasin_client' table.
 *
 * 
 *
...
abstract class BaseClientPeer {
	...
	const TABLE_NAME = 'magasin_client';
	...
	const ID = 'magasin_client.ID';

	/** the column name for the NOM field */
	const NOM = 'magasin_client.NOM';

	/** the column name for the PRENOM field */
	const PRENOM = 'magasin_client.PRENOM';

	/** the column name for the ADRESSE field */
	const ADRESSE = 'magasin_client.ADRESSE';

	/** the column name for the MAIL field */
	const MAIL = 'magasin_client.MAIL';

	/** the column name for the TELEPHONE field */
	const TELEPHONE = 'magasin_client.TELEPHONE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Nom', 'Prenom', 'Adresse', 'Mail', 'Telephone', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nom', 'prenom', 'adresse', 'mail', 'telephone', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NOM, self::PRENOM, self::ADRESSE, self::MAIL, self::TELEPHONE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'nom', 'prenom', 'adresse', 'mail', 'telephone', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nom' => 1, 'Prenom' => 2, 'Adresse' => 3, 'Mail' => 4, 'Telephone' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nom' => 1, 'prenom' => 2, 'adresse' => 3, 'mail' => 4, 'telephone' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NOM => 1, self::PRENOM => 2, self::ADRESSE => 3, self::MAIL => 4, self::TELEPHONE => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nom' => 1, 'prenom' => 2, 'adresse' => 3, 'mail' => 4, 'telephone' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ClientPeer::MAIL);
		$criteria->addSelectColumn(ClientPeer::TELEPHONE);
	}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to magasin_client
	...
	/**
	 * Method to DELETE all rows from the magasin_client table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
