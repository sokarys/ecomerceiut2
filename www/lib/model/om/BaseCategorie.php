...
/**
 * Base class that represents a row from the 'magasin_categorie' table.
 *
 * 
 *
...
abstract class BaseCategorie extends BaseObject  implements Persistent {
	 ...
	 * related Articles from storage. If this Categorie is new, it will return
		...
		if ($this->collArticles === null) {
			if ($this->isNew()) {
			   $this->collArticles = array();
				...
				$criteria->add(ArticlePeer::CATEGORIE_ID, $this->id);
