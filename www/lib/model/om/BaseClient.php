...
/**
 * Base class that represents a row from the 'magasin_client' table.
 *
 * 
 *
...
abstract class BaseClient extends BaseObject  implements Persistent {
	...
	public function setMail($v)
	{
		...
		if ($this->mail !== $v) {
			$this->mail = $v;
			$this->modifiedColumns[] = ClientPeer::MAIL;
		}
	...
	public function setTelephone($v)
	{
		...
		if ($this->telephone !== $v) {
			$this->telephone = $v;
			$this->modifiedColumns[] = ClientPeer::TELEPHONE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = ClientPeer::NUM_COLUMNS - ClientPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ClientPeer::MAIL)) $criteria->add(ClientPeer::MAIL, $this->mail);
		if ($this->isColumnModified(ClientPeer::TELEPHONE)) $criteria->add(ClientPeer::TELEPHONE, $this->telephone);
	 ...
	 * related Paniers from storage. If this Client is new, it will return
		...
		if ($this->collPaniers === null) {
			if ($this->isNew()) {
			   $this->collPaniers = array();
				...
				$criteria->add(PanierPeer::CLIENT_ID, $this->id);
	...
	public function getPaniersJoinArticle($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		if ($this->collPaniers === null) {
			if ($this->isNew()) {
				...
				$this->collPaniers = PanierPeer::doSelectJoinArticle($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Client has previously been saved, it will retrieve
	 * related Commandes from storage. If this Client is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collCommandes === null) {
			if ($this->isNew()) {
			   $this->collCommandes = array();
				...
				$criteria->add(CommandePeer::CLIENT_ID, $this->id);
	 ...
	 * actually need in Client.
	 */
	public function getCommandesJoinArticle($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ClientPeer::DATABASE_NAME);
		}
		...
		if ($this->collCommandes === null) {
			if ($this->isNew()) {
				...
				$this->collCommandes = CommandePeer::doSelectJoinArticle($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
