...
/**
 * Base class that represents a row from the 'magasin_article' table.
 *
 * 
 *
...
abstract class BaseArticle extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the popularite field.
	 * @var        int
	 */
	protected $popularite;
	...
	/**
	 * @var        array Panier[] Collection to store aggregation of Panier objects.
	 */
	protected $collPaniers;

	/**
	 * @var        Criteria The criteria used to select the current contents of collPaniers.
	 */
	private $lastPanierCriteria = null;

	/**
	 * @var        array Commande[] Collection to store aggregation of Commande objects.
	 */
	protected $collCommandes;

	/**
	 * @var        Criteria The criteria used to select the current contents of collCommandes.
	 */
	private $lastCommandeCriteria = null;
	...
	/**
	 * Get the [popularite] column value.
	 * 
	 * @return     int
	 */
	...
	public function setNom($v)
	{
		...
		if ($this->nom !== $v) {
			$this->nom = $v;
			$this->modifiedColumns[] = ArticlePeer::NOM;
		}
	...
	public function setPrix($v)
	{
		...
		if ($this->prix !== $v) {
			$this->prix = $v;
			$this->modifiedColumns[] = ArticlePeer::PRIX;
		}
	...
	/**
	 * Set the value of [popularite] column.
	 * 
	 * @param      int $v new value
	 * @return     Article The current object (for fluent API support)
	 */
	public function setPopularite($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->popularite !== $v) {
			$this->popularite = $v;
			$this->modifiedColumns[] = ArticlePeer::POPULARITE;
		}
	...
	public function setStock($v)
	{
		...
		if ($this->stock !== $v) {
			$this->stock = $v;
			$this->modifiedColumns[] = ArticlePeer::STOCK;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->popularite = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->stock = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->categorie_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->resetModified();
			...
			return $startcol + 7; // 7 = ArticlePeer::NUM_COLUMNS - ArticlePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->lastPanierCriteria = null;

			$this->collCommandes = null;
			$this->lastCommandeCriteria = null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[4] => $this->getPopularite(),
			$keys[5] => $this->getStock(),
			$keys[6] => $this->getCategorieId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setPopularite($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setStock($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setCategorieId($arr[$keys[6]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArticlePeer::NOM)) $criteria->add(ArticlePeer::NOM, $this->nom);
		if ($this->isColumnModified(ArticlePeer::PRIX)) $criteria->add(ArticlePeer::PRIX, $this->prix);
		if ($this->isColumnModified(ArticlePeer::DESCRIPTION)) $criteria->add(ArticlePeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(ArticlePeer::POPULARITE)) $criteria->add(ArticlePeer::POPULARITE, $this->popularite);
		if ($this->isColumnModified(ArticlePeer::STOCK)) $criteria->add(ArticlePeer::STOCK, $this->stock);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPopularite($this->popularite);
	...
	/**
	 * Clears out the collPaniers collection (array).
	 *
	...
	/**
	 * Initializes the collPaniers collection (array).
	 *
	 ...
	 * @return     void
	 */
	public function initPaniers()
	{
		$this->collPaniers = array();
	}
	 ...
	 * related Paniers from storage. If this Article is new, it will return
		...
		if ($this->collPaniers === null) {
			if ($this->isNew()) {
			   $this->collPaniers = array();
				...
				$criteria->add(PanierPeer::ARTICLE_ID, $this->id);

				PanierPeer::addSelectColumns($criteria);
				$this->collPaniers = PanierPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				PanierPeer::addSelectColumns($criteria);
				if (!isset($this->lastPanierCriteria) || !$this->lastPanierCriteria->equals($criteria)) {
					$this->collPaniers = PanierPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastPanierCriteria = $criteria;
	...
	public function countPaniers(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collPaniers === null) {
			if ($this->isNew()) {
				...
				$count = PanierPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	public function addPanier(Panier $l)
	{
		...
		if (!in_array($l, $this->collPaniers, true)) { // only add it if the **same** object is not already associated
			array_push($this->collPaniers, $l);
			$l->setArticle($this);
		}
	}
	 ...
	 */
	public function getPaniersJoinClient($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ArticlePeer::DATABASE_NAME);
		}
		...
		if ($this->collPaniers === null) {
			if ($this->isNew()) {
				...
				$this->collPaniers = PanierPeer::doSelectJoinClient($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collCommandes collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	...
	/**
	 * Initializes the collCommandes collection (array).
	 *
	 ...
	 * @return     void
	 */
	public function initCommandes()
	{
		$this->collCommandes = array();
	}

	/**
	 * Gets an array of Commande objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Article has previously been saved, it will retrieve
	 * related Commandes from storage. If this Article is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function getCommandes($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ArticlePeer::DATABASE_NAME);
		}
		...
		if ($this->collCommandes === null) {
			if ($this->isNew()) {
			   $this->collCommandes = array();
				...
				$criteria->add(CommandePeer::ARTICLE_ID, $this->id);

				CommandePeer::addSelectColumns($criteria);
				$this->collCommandes = CommandePeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				CommandePeer::addSelectColumns($criteria);
				if (!isset($this->lastCommandeCriteria) || !$this->lastCommandeCriteria->equals($criteria)) {
					$this->collCommandes = CommandePeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastCommandeCriteria = $criteria;
	 ...
	 * @throws     PropelException
	 */
	public function countCommandes(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ArticlePeer::DATABASE_NAME);
		} else {
		...
		if ($this->collCommandes === null) {
			if ($this->isNew()) {
				...
				$count = CommandePeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastCommandeCriteria) || !$this->lastCommandeCriteria->equals($criteria)) {
					...
					$count = count($this->collCommandes);
				}
			} else {
				$count = count($this->collCommandes);
			}
	...
	/**
	 * Method called to associate a Commande object to this object
	 * through the Commande foreign key attribute.
	 *
	 * @param      Commande $l Commande
	 * @return     void
	 * @throws     PropelException
	 */
	public function addCommande(Commande $l)
	{
		if ($this->collCommandes === null) {
			$this->initCommandes();
		}
		if (!in_array($l, $this->collCommandes, true)) { // only add it if the **same** object is not already associated
			array_push($this->collCommandes, $l);
			$l->setArticle($this);
		}
	}
	 ...
	 * actually need in Article.
	 */
	public function getCommandesJoinClient($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ArticlePeer::DATABASE_NAME);
		}
		...
		if ($this->collCommandes === null) {
			if ($this->isNew()) {
				...
				$this->collCommandes = CommandePeer::doSelectJoinClient($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collPaniers) {
				foreach ((array) $this->collPaniers as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collCommandes) {
				foreach ((array) $this->collCommandes as $o) {
					$o->clearAllReferences($deep);
				}
			}
		} // if ($deep)
