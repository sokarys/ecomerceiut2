...
abstract class BaseArticle extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->popularite = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			...
			return $startcol + 6; // 6 = ArticlePeer::NUM_COLUMNS - ArticlePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setPopularite($arr[$keys[3]]);
