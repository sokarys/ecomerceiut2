...
abstract class BaseCommandePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('ClientId', 'ArticleId', 'Quantite', 'CreatedAt', 'Etat', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('clientId', 'articleId', 'quantite', 'createdAt', 'etat', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::CLIENT_ID, self::ARTICLE_ID, self::QUANTITE, self::CREATED_AT, self::ETAT, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('client_id', 'article_id', 'quantite', 'created_at', 'etat', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('ClientId' => 0, 'ArticleId' => 1, 'Quantite' => 2, 'CreatedAt' => 3, 'Etat' => 4, 'Id' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('clientId' => 0, 'articleId' => 1, 'quantite' => 2, 'createdAt' => 3, 'etat' => 4, 'id' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::CLIENT_ID => 0, self::ARTICLE_ID => 1, self::QUANTITE => 2, self::CREATED_AT => 3, self::ETAT => 4, self::ID => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('client_id' => 0, 'article_id' => 1, 'quantite' => 2, 'created_at' => 3, 'etat' => 4, 'id' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
