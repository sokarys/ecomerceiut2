...
/**
 * Base static class for performing query and update operations on the 'magasin_commande' table.
 *
 * 
 *
...
abstract class BaseCommandePeer {
	...
	const TABLE_NAME = 'magasin_commande';
	...
	const CLIENT_ID = 'magasin_commande.CLIENT_ID';

	/** the column name for the ARTICLE_ID field */
	const ARTICLE_ID = 'magasin_commande.ARTICLE_ID';

	/** the column name for the QUANTITE field */
	const QUANTITE = 'magasin_commande.QUANTITE';

	/** the column name for the ID field */
	const ID = 'magasin_commande.ID';
	...
	/**
	 * Method to invalidate the instance pool of all tables related to magasin_commande
	...
	/**
	 * Method to DELETE all rows from the magasin_commande table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
