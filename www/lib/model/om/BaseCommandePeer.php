...
abstract class BaseCommandePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('ClientId', 'CreatedAt', 'Etat', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('clientId', 'createdAt', 'etat', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::CLIENT_ID, self::CREATED_AT, self::ETAT, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('client_id', 'created_at', 'etat', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('ClientId' => 0, 'CreatedAt' => 1, 'Etat' => 2, 'Id' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('clientId' => 0, 'createdAt' => 1, 'etat' => 2, 'id' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::CLIENT_ID => 0, self::CREATED_AT => 1, self::ETAT => 2, self::ID => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('client_id' => 0, 'created_at' => 1, 'etat' => 2, 'id' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
