...
/**
 * Base class that represents a row from the 'magasin_panier' table.
 *
 * 
 *
...
abstract class BasePanier extends BaseObject  implements Persistent {
	...
	public function setClientId($v)
	{
		...
		if ($this->client_id !== $v) {
			$this->client_id = $v;
			$this->modifiedColumns[] = PanierPeer::CLIENT_ID;
		}
	...
	public function setArticleId($v)
	{
		...
		if ($this->article_id !== $v) {
			$this->article_id = $v;
			$this->modifiedColumns[] = PanierPeer::ARTICLE_ID;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PanierPeer::ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = PanierPeer::NUM_COLUMNS - PanierPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BasePanier:delete:pre') as $callable)
			{
			...
			if ($ret) {
				PanierPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePanier:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BasePanier:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePanier:save:post') as $callable)
				{
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PanierPeer::doInsert($this, $con);
					...
					$affectedRows += PanierPeer::doUpdate($this, $con);
				}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PanierPeer::CLIENT_ID)) $criteria->add(PanierPeer::CLIENT_ID, $this->client_id);
		if ($this->isColumnModified(PanierPeer::ARTICLE_ID)) $criteria->add(PanierPeer::ARTICLE_ID, $this->article_id);
		if ($this->isColumnModified(PanierPeer::QUANTITE)) $criteria->add(PanierPeer::QUANTITE, $this->quantite);
		if ($this->isColumnModified(PanierPeer::ID)) $criteria->add(PanierPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PanierPeer::ID, $this->id);
	...
	{
	  if (!$callable = sfMixer::getCallable('BasePanier:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BasePanier::%s', $method));
	  }
