...
/**
 * This class defines the structure of the 'magasin_client' table.
 *
 *
...
class ClientTableMap extends TableMap {
	...
	{
    $this->addRelation('Panier', 'Panier', RelationMap::ONE_TO_MANY, array('id' => 'client_id', ), null, null);
