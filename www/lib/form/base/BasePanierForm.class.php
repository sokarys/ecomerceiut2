...
/**
 * Panier form base class.
 *
 * @method Panier getObject() Returns the current form's model object
 *
 * @package    ecommerce
 * @subpackage form
 * @author     Your name here
 */
abstract class BasePanierForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('panier[%s]');
